...
for (m in 1:mc)
  {
    ...
    mc.results[m,1] = (count1/sims)
    mc.results[m,2] = (count2/sims)
    mc.results[m,3] = (count3/sims)
    mc.results[m,4] = (count4/sims)
...
print(mean(mc.results[,1] < .1))
print(mean(mc.results[,2] < .1))
print(mean(mc.results[,3] < .1))
print(mean(mc.results[,4] < .1))
print(mean(mc.results[,5] < .1))
