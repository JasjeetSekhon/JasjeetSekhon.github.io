...
\date{Class: 4--7pm Wed\\130 Wheeler}
...
\begin{quote}
  ...
  Blum Hall 130 (former Naval Architecture Building)\\
\end{quote}

\begin{quote}
  \textbf{Yotam Shem-Tov, GSI}\\
  \hlink{\texttt{shemtov@berkeley.edu}}{shemtov@berkeley.edu} \\
  Section: Thursday 5--7, 229 Dwinelle\\
\end{quote} 
...
Covers randomized experiments with and without noncompliance,
observational studies with and without ignorable treatment assignment,
instrumental variables, regression discontinuity, sensitivity
analysis, and permutation inference. Applications are drawn from a
variety of fields including political science, economics, sociology,
public health, and medicine.

%\\
%
%This course can be used to meet the Political Science Department's
%Methodology course-out option.

\subsection*{Prerequisites}

A multivariate regression course with linear algebra, upper division
probability and statistics, and familiarity with high-level
programming languages. PS236a and PS236b or Statistics 133, 134, and
135 are recommended.  The programming language used in the course is
\Rsymb.  

If you need to review material, please consult David Freedman's
excellent \textit{Statistical Models: Theory and Practice} or John
Fox's \textit{Applied Regression Analysis, Linear Models, and Related
...
Date for the midterm: week of November 18.

When you email me about the course, please start the subject of the email with the text inside of the following quotes: ``[CI:]'' (note the square brackets, and ignore the quotes).
...
\hlink{\Rsymb}{http://www.r-project.org/}.  It is available for
download from:\\
\hlink{\texttt{http://www.r-project.org/}}{http://www.r-project.org/}.
\hlink{\Rsymb}{http://www.r-project.org/} is open source software
(released under the \hlink{GNU public license}{http://www.gnu.org/}).

The books listed below are available at various online
bookstores. These books are not required, but most purchase them
because we assume that you have access to them when needed.

\begin{itemize}
\item Rubin, Donald.  2006.  \textit{Matched Sampling for Causal
    Effects}.  Cambridge University Press.  ISBN 0521674360. Note:
  this is a collection of articles that you can also find on JSTOR.
...
\item Freedman, David A. 2010. \textit{Statistical Models and Causal
  ...
  University Press. ISBN-10 0521123909. Note: this is a collection of
  articles that you can also find elsewhere.

\item Rosenbaum, Paul R.  2002.  \textit{Observational Studies}.
  Springer-Verlag.  2nd edition.  ISBN 0387989676.
\end{itemize}

The following books may be of additional help:
\begin{itemize}
...
\item Rosenbaum, Paul R.  2009.  \textit{Design of Observational
  ...
  \url{http://www.springerlink.com/content/978-1-4419-1212-1/#section=627451&page=1}

\item Venables, W.N and Brian D.~Ripley.  2010.  \textit{Modern
...
Extra reading:
\begin{itemize}
\item \cite{Sekhon2004}: \hlink{``Quality Meets Quantity: Case
    Studies, Conditional Probability and
    Counterfactuals''}{http://sekhon.berkeley.edu/papers/QualityQuantity.pdf}
...
\begin{itemize}
  \item \citet{rosenbaum2002}: chapters on sensitivity analysis
  \item \citet{rosenbaum2005}: why more data (even big data) isn't
    necessarily better. Also links Mill to Fisher.
\end{itemize}
...
\item \textsc{Synthetic Cohorts} \\
  ...
  \begin{itemize}
  \item \citet{abadie2010synthetic}: \href{http://www.hks.harvard.edu/fs/aabadie/ccsp.pdf}{Synthetic control methods       for comparative case studies: Estimating the effect of       California]s tobacco control program}
...
% LocalWords:  Verlag nd Rocio Titiunik GSI Dwinelle sekhon online Yotam Rsymb Venables th
% LocalWords:  Webpage Neyman rubin rosenbaum DiamondSekhon Shem-Tov Rsymb unconfoundedness pm
% LocalWords:  pdf Counterfactuals mimeo DOI Imai Kosuke causalinf TBA 3AETEEOT Tu sec
% LocalWords:  CA ISBN com ACSSA JSTOR ToC Berk Blalock pp Cochran's 3ACEINSR Cochran
...
% LocalWords:  DehejiaWahba1999 3ACEINSR citeauthor BowersPanagopoulos2011 GilliganSergenti2006 Imbens
...
% LocalWords:  miratrix2012adjusting Deaton textit
