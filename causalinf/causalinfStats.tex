...
\date{Class: 4-7pm Monday\\200 Wheeler}
...
\begin{quote}
  \textbf{Danny Hidalgo, GSI}\\
  \hlink{\texttt{fdhidalgo@berkeley.edu}}{fdhidalgo@berkeley.edu} \\
  Office: Survey Research Center, 2638 Channing Way\\
  Section: Wed 2--4 PM in 200 Wheeler
\end{quote}

\begin{quote}
  \textbf{Erin Hartman, GSI}\\
  \hlink{\texttt{ekhartman@berkeley.edu}}{ekhartman@berkeley.edu} \\
  Office: Survey Research Center, 2638 Channing Way\\
  Section: Wed 2--4 PM in 200 Wheeler
\end{quote}
...
The three books listed below are required and available at various
online bookstores and at the University Book Store.
...
\item \textsc{Randomization Inference} 
  ...
  \begin{itemize}
  \item \citet[][ch 1--2]{fisher1935}: \textit{Design of Experiments}
  ...
  Extra reading:
  \begin{itemize}
  \item Application to correct issues with weak instruments and
    2SLS: \citet{ImbensRosenbaum2005}: ``Randomization Inference with
    an Instrumental Variable,'' \textit{Journal of the Royal
      Statistical Society}, Series A, vol 168(1), 109--126.
...
\item \textsc{Matching Examples Using Observational Data} \\
  Please read
  the first three of the Political Science examples listed here and
  any of the others you find of interest.  An effort has been made to
...
%    a Survey of Lottery Players", American Economic Review, 91, 778­794.
  ...
  \begin{itemize}
  \item \citet{ImbensRosenbaum2005}: ``Randomization Inference with
    an Instrumental Variable,'' \textit{Journal of the Royal Statistical
      Society}, Series A, vol 168(1), 109--126.

  \item \citet{AngristKrueger1991}: ``Does compulsory school attendance
    affect earnings?'' \textit{QJE} 1991; 106: 979--1019.
...
% LocalWords:  Multinomial HerronWand sekhonJSS
