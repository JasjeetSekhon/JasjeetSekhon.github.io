...
plot(seq(0,0.5, by=0.05),mean.of.estimates,ylim=c(0.25,0.35),xlab="Importance of Stress",ylab="Expectation of Estimate",main="Bias Increases as Stress Makes Eating Fast Food More Likely")
...
plot(seq(0,0.5, by=0.05),mean.of.estimates,ylim=c(0.25,0.35),xlab="Importance of Stress",ylab="Expectation of Estimate",main="Bias Increases as Stress Makes Heart Disease More Likely")
abline(h=0.3,col="blue")
text(0.4, 0.304,"Parameter",col="blue")
...
rr <- Match(Y=Y, Tr=Tr, X=cbind(dta$b00pc, dta$b00pc_sq, dta$d96pc1, dta$v_change, dta$income, dta$hispanic, dta$b00pc_e, dta$b00pcsq_e), estimand="ATT")
summary(rr)

# So what this shows is that regression finds a significant effect because it is extrapolating from uninformative points. Matching shows that when you compare the counties with e-touch to similar counties without e-touch, there is no discernable effect
