...
# So we have 1000 people. The first 100 will take orange juice. 50-200 will get extra rest. The only covariate that we have data on is age.
...
# Orange juice will decrease the days sick by 1, and extra rest will decrease the days sick by 2. Age will increase days sick.
