...
# Maximize the minimum p-value, giving more weight to the first covariate (we will treat the p-values for the first covariate as half their actual value)
...
# Restrict the search to just weighting schemes that give us better balance on every covariate than we had in the initial dataset.
