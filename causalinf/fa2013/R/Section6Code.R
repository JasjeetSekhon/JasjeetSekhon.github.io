...
# We will take a sample of 100. To estimate the sampling distribution, we will take 10,000 samples with replacement from our original sample of 100. The size of each new sample will be 100.
...
# We can compare this sampling distribution to the real sampling distribution.  Since we know the data is Exp(1), we can create a very accurate estimate the distribution of the median with Monte Carlo Simulation
