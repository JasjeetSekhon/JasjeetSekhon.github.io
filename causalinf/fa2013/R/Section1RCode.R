...
deck=sample(c(rep(2:14,4), 52, replace=FALSE) # We are labeling Jack=11, Queen=12's, King=13, and Ace=14. This line of code produces a well shuffled deck of cards (without suits).
